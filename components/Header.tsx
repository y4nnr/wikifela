...
export default function Header() {
  ...
  return (
    <>
      ...
      <header className="border-b border-gray-800 bg-[#0a0a0a] relative z-50">
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-[#0a0a0a] border-t border-gray-800 safe-bottom">
