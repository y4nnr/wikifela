    ...
    return (
      <div className="flex-1 flex flex-col items-center">
        <div className="w-full max-w-3xl">
          <PageTitle title="Tapissage" subtitle="Identifiez l'accusé parmi les suspects" />
        </div>
        ...
        <div className="w-full max-w-sm space-y-6 px-4">
          ...
          {mode === "classique" && (
            <div>
              <label className="block text-sm text-[var(--fg-muted)] mb-3">Nombre de tapissages</label>
              <div className="flex gap-3">
                {[3, 5, 8].map((n) => (
                  <button
                    key={n}
          ...
          {mode === "survie" && (
            <div className="mt-2">
              <Leaderboard game="tapissage" readOnly />
            </div>
          )}
        </div>
      </div>
    ...
    return (
      <div className="flex-1 flex flex-col items-center justify-center px-4">
        <div className="text-center max-w-sm w-full">
          ...
          <div className="mb-4">
            <Leaderboard game="tapissage" playerScore={score} />
          </div>
    ...
    <div className="flex-1 flex flex-col items-center justify-center px-4">
      <div className="text-center max-w-sm w-full">
        <div className="border border-[var(--border)] rounded-lg bg-[var(--bg-card)] p-5 sm:p-6 mb-6">
          <div className="text-[10px] text-[var(--fg-dim)] uppercase tracking-wider mb-4">Résultat du tapissage</div>
          ...
          <p className="text-sm text-[var(--fg-dim)]">{percentage}% d&apos;identifications correctes</p>
        </div>
